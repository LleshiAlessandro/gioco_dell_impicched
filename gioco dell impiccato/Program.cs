...
Console.WriteLine("Prima di inizare a giocare devi dirmi quante parole vorresti indovinare");
int indovinaP = 0;
indovinaP = int.Parse(Console.ReadLine());
Console.WriteLine(indovinaP);
while (indovinaP > 0)
{
    Console.WriteLine();
    Console.WriteLine();
    ...
    indovinaP--;
    Console.WriteLine("i tuoi punti sono:" + punti);
}
